...
// Import subscription renewal worker
import { startSubscriptionRenewalWorker, stopSubscriptionRenewalWorker } from './services/subscription-renewal.service';
...
process.on('SIGTERM', async () => {
  ...
  await stopSubscriptionRenewalWorker();
  await closeSentry();
  server.close(() => {
