...
const ConsultoriosPage = () => {
  ...
  const jsonLd = JSON.stringify({
    ...
    '@type': 'Service',
    name: 'Agendux para Consultorios',
    description: 'Sistema de gestión de turnos online para consultorios. Reservas 24/7, recordatorios por WhatsApp y sincronización con Google Calendar.',
    url: 'https://agendux.com/para-consultorios',
    provider: {
      '@type': 'Organization',
      name: 'Agendux',
  ...
  return (
    <div className="bg-white">
      <Helmet>
        <title>Gestión de turnos online para consultorios | Agendux</title>
        <meta name="description" content="Sistema de turnos online para consultorios. Tus pacientes reservan solos 24/7. Recordatorios automáticos por WhatsApp. Reducí ausencias hasta un 75%. Comenzá gratis." />
        <link rel="canonical" href="https://agendux.com/para-consultorios" />
        <meta property="og:title" content="Gestión de turnos online para consultorios | Agendux" />
        <meta property="og:description" content="Sistema de turnos online para consultorios. Tus pacientes reservan solos 24/7. Recordatorios por WhatsApp. Comenzá gratis." />
        <meta property="og:url" content="https://agendux.com/para-consultorios" />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white rounded-lg p-6 shadow-sm fade-up-normal">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Recepción colapsada</h3>
              <p className="text-gray-600 text-sm">
                El teléfono suena todo el día. WhatsApp se acumula. Tu equipo pierde tiempo coordinando turnos en lugar de atender pacientes.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm fade-up-normal">
              <TrendingDownIcon sx={{ fontSize: 40, color: '#ef4444', mb: 2 }} />
              <h3 className="font-semibold text-gray-900 mb-2">Ausentismo constante</h3>
              <p className="text-gray-600 text-sm">
                Pacientes que reservan y no vienen. Sin aviso, sin posibilidad de reasignar ese turno. Huecos en la agenda que afectan a todo el consultorio.
              </p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-sm fade-up-normal">
              <AttachMoneyIcon sx={{ fontSize: 40, color: '#ef4444', mb: 2 }} />
              <h3 className="font-semibold text-gray-900 mb-2">Facturación afectada</h3>
              <p className="text-gray-600 text-sm">
                Las ausencias impactan directo en los ingresos del consultorio. Un turno vacío es una consulta que no se cobra.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto fade-up-normal">Un sistema diseñado para que la gestión de turnos de tu consultorio sea automática</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center fade-up-normal">
              ...
              <p className="text-gray-600 text-sm">Cada turno aparece automáticamente en tu Google Calendar. Todos los profesionales del consultorio sincronizados.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              'Liberá a tu recepción de coordinar turnos por teléfono y WhatsApp',
              'Tus pacientes reservan solos a cualquier hora, incluso fuera del horario de atención',
              'Agenda de cada profesional sincronizada con Google Calendar',
              'Link personalizado por profesional (agendux.com/drnombre) para compartir con pacientes',
              'Código QR listo para imprimir y poner en la recepción',
            ].map((benefit, i) => (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center fade-up-normal">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Configurá la agenda</h3>
              <p className="text-gray-600 text-sm">Definí horarios de atención, duración de consulta y días disponibles para cada profesional.</p>
            </div>
            <div className="text-center fade-up-normal">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Compartí el link</h3>
              <p className="text-gray-600 text-sm">Cada profesional tiene su link. Compartilo por WhatsApp, redes o email. Los pacientes reservan solos.</p>
            </div>
          </div>
        </div>
      </div>
