...
const GoogleCalendarHeader = ({ error, successMessage }: GoogleCalendarHeaderProps) => {
  return (
    <>
      {/* Header */}
      <div className="mb-6 fade-down-normal">
        <h1 className="text-2xl font-bold text-gray-900 fade-up-fast">Google Calendar</h1>
        <p className="mt-1 text-sm text-gray-600 fade-up-normal">
          Sincroniza tus citas con Google Calendar para tener todo en un solo lugar
        </p>
      </div>
